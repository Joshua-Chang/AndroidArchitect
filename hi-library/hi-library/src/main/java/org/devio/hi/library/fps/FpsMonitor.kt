...
object FpsMonitor {
    ...
    fun listener(callback: FpsCallback) {/*监听回调*/
    ...
    private class FpsViewer {
        ...
        init {
            ...
            params.flags =
                WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE /*不抢占焦点*/or WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE /*不可触摸*/or WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL/*不可拦截手势*/
