...
class HiRNCacheManager private constructor() {
    ...
    fun preLoad(activity: Activity, moduleName: String, initParams: Bundle) {
        ...
        Looper.myQueue().addIdleHandler {
            ...
            reactRootView.reactInstanceManager?.onHostDestroy(activity)//预加载时，不让其控制activity，比如修改activity状态栏
            CACHED_VIEW[moduleName] = reactRootView/*缓存*/
            false
        }
    }
    ...
    private fun initReactRootView(
        ...
        val reactInstanceManager = ReactInstanceManager.builder()
            ...
            .setBundleAssetName("index.android.bundle")/*打包的assest*/
            .setJSMainModulePath("index")
            .addPackage(MainReactPackage())
            .addPackage(HiReactPackage())
            .addPackage(HiRNImageViewPackage())/*注册原生view的package*/
