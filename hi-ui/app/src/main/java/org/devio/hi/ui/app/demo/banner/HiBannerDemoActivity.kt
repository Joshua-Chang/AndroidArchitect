...
class HiBannerDemoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MApplication.shortCut("032:banner",this)
...
//            }
    ...
    private fun initView(hiIndicator: HiIndicator<*>?, autoPlay: Boolean) {
        ...
        mHiBanner.setIntervalTime(5000)//间隔时长
        // TODO: 2020/12/10 druation > interval时有问题
        mHiBanner.setScrollDuration(5000)//每滚一个page的时长
        //自定义布局
        ...
        mHiBanner.setBindAdapter { viewHolder, mo, position ->
            ...
            titleView.setOnClickListener {
                Log.e("eee",titleView.text.toString())
            }
            titleView.text = mo.url
        }

//        mHiBanner.setOnPageChangeListener(object :ViewPager.OnPageChangeListener{
